...
module.exports = {
    ...
    aliases: ['cmd', 'cmdlist'],
    cooldown: 60,
    description: 'Show a list of commands. Use v help <command> to check the detail of the command. (Haven\'t Update)',
    usage: 'command',
    category: 'Info',
    async execute(client, message, args, Discord) {
        const embed1 = new Discord.MessageEmbed()
            ...
            .addFields(
                ...
                { name: 'animeimg <pat/hug/waifu/cry/kiss/slap/smug/punch>', value: 'get an anime image or gif according to the type you want' },
