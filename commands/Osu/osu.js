    ...
    async execute(client, message, args) {
        try {
            ...
            const embed = new Discord.MessageEmbed()
                .setColor('#2f3136')
                .setTitle(`:flag_${flagnam}:  osu!circle profile for ${uname}`)
                ...
                //.addField('Rank count:', `<:osu_b:854288796271116288> ${au.counts.B}\n <:osu_c:854288819671269386>  ${au.counts.C}\n <:osu_d:854288842982686740>  ${au.counts.D}\n <:osu_f:854288872590278666>  ${au.counts.F}`, true)
