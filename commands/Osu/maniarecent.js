...
module.exports = {
    name: 'maniarecent',
    aliases: ["maniarc", "maniarecent", "mnrc", "mnrecent"],
    category: "Osu",
    description: "Check out someone recent play beatmap last 24 hours in osu mania mode.",
        ...
        try {
            ...
            osuApi.getUserRecent({ u: args[0], m: '2' }).then(scores => {
                const recent = new Discord.MessageEmbed()
                    .setTitle(`${user}'s Recent Playing Record in Mania Mode`)
                    .setColor('#FF1493')
            ...
            message.lineReplyNoMention(`${user} didn\'t play osu mania mode recently.`)
        }
    }
}