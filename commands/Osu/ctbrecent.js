...
module.exports = {
    name: 'ctbrecent',
    aliases: ["ctbrc", "ctbrecent"],
    category: "Osu",
    description: "Check out someone recent play beatmap last 24 hours in osu ctb mode.",
    usage: "ctbrecent <username>",
    cooldown: 5,
    async execute(client, message, args) {
        try {
            ...
            message.lineReplyNoMention(`${user} didn\'t play osu ctb mode recently.`)
        }
    } 
}