...
module.exports = {
    ...
    async execute (client, message, args) {
        ...
        if (!args[0]) {
            return message.lineReplyNoMention("Please Enter a valid STEAMID64");
        }
        ...
        request(UR_L, function (err, resp, body) {
            ...
            if (KD == -1) {
                return message.lineReplyNoMention("Invalid, make sure your profile is not private and you have entered a valid STEAMID64!");
            }
