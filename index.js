...
client.distube = new DisTube(client, { youtubeCookie: COOKIE, searchSongs: 15, emitNewSongOnly: true, leaveOnFinish: false, leaveOnEmpty: false, emptyCooldown: 7000, plugins: [new SpotifyPlugin({ parallel: true })] })
